object frmMain: TfrmMain
  ...
  object Panel1: TPanel
    ...
    object edAPIURL: TLabeledEdit
      ...
      TabOrder = 1
      Text = 
        'https://eastus.api.cognitive.microsoft.com/vision/v3.2/read/anal' +
        'yze'
    end
    ...
    object edOpLocation: TLabeledEdit
      Left = 15
      Top = 161
      Width = 346
      Height = 21
      EditLabel.Width = 88
      EditLabel.Height = 13
      EditLabel.Caption = 'Operation location'
      ReadOnly = True
      TabOrder = 4
    end
  end
